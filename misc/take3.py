...
## Clock Dynamics
t1, t2, t3, l2, l3 = Ints('t1 t2 t3 l2 l3')
z1 = Real('z1')  # assign objective function to this


# Clock constraints
opt.add(2 <= t1, t1 <= 3)
opt.add(t2 <= 6, t3 <= 6, l2 >= 3, l3 >= 3)
opt.add(t2 == t1+l2, t3 == t1+l3)
...
opt.add(z1 == b00*l2*1 + b01*l3*2 + t1*1)
opt.minimize(z1)
